...
const azureSiteUrlEnvName = `ENV_AZURE_${'TECH' + 'HUB'}_SITE_URL`;
const azureSiteUrl = process.env[azureSiteUrlEnvName as string];
...
const config: Config = {
  ...
  url: azureSiteUrl ? azureSiteUrl : 'http://localhost:3000',
  ...
  themeConfig: {
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/your-org/docusaurops-template',
          position: 'right',
          html: `
              <a style="display:flex" href="https://github.com/your-org/docusaurops-template" target="_blank" rel="noreferrer noopener" aria-label="Components playground">
        ...
        {
          href: azureSiteUrl ? azureSiteUrl : '/',
            ...
            return {
              ...
              plugins: [
                new webpack.EnvironmentPlugin({
                  ENV_AZURE_DOCUSAUROPS_SITE_URL: azureSiteUrl ? azureSiteUrl : 'http://localhost:3000',
                  ENV_BASE_URL: process.env.ENV_BASE_URL ? process.env.ENV_BASE_URL : '/',
                  ENV_SEARCH_URL: process.env.ENV_SEARCH_URL ? process.env.ENV_SEARCH_URL : 'http://localhost:3000'
                })
              ]
            };
        }
